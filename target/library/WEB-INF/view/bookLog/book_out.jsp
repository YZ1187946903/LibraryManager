...
<head>
	<title>Title</title>
	<%--	http://localhost:8080/library/bookLog/out--%>
	...
	<script type="application/javascript">
		...
		// 出库函数
		function bookOut(){
			var title = "<i class='fa fa-window-minimize'></i>&nbsp;进行出库操作";
			// 嵌入 iframe 中的 url
			var url = "bookLog/delete";
			// 设定宽度和高度
			var width = 600;
			var heigth = 500;
			// 获得该页面的父页面对象
...
<div class="container" style="margin: 10px 5px;">
	<div class="row">
		<div class="col-md-12">
			<a href="javascript:bookOut()" class="btn btn-success">
